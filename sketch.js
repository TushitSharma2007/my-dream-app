...
function setup(){
    ...
    link = createA('https://tushitsharma2007.github.io/my-dream-app-form-1','Please tap here to begin')
...
function draw(){
    ...
    text("Why is and what is Helping hands?",windowWidth/40,windowHeight/1.3);
}
